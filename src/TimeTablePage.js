...
const TimeTablePage = () => {
    ...
    // Function to handle timetable display
    const handleTimetableDisplay = () => {
        if (semester && branch && section) {
            // Example image paths - you would replace these with your actual paths
            const imagePath = `/timetables/${branch}/${semester}/${section}.jpg`;
            setTimetableImage(imagePath);
        }
    };

    // Remove the useEffect and rely on the handleTimetableDisplay function instead
    ...
    const handleSemesterChange = (event) => {
        ...
        // Call handleTimetableDisplay after updating state if other fields are filled
        setTimeout(() => {
        ...
        <Box sx={{ display: 'flex', backgroundColor: '#f8fafc', minHeight: '100vh' }}>
            ...
            <Box sx={{ flexGrow: 1, overflow: 'auto', p: 3 }}>
                ...
                <Paper sx={{ p: 3, borderRadius: 4 }}>
                    ...
                    {/* Sample timetable links for demo purposes */}
                    {/* These would be replaced with actual timetable images in production */}
                    <Box sx={{ display: 'none' }}>
                        <img src="/timetables/cse/sem1/a.jpg" alt="CSE Sem 1 Section A" />
                        <img src="/timetables/cse/sem1/b.jpg" alt="CSE Sem 1 Section B" />
                        <img src="/timetables/ece/sem2/a.jpg" alt="ECE Sem 2 Section A" />
